...
public abstract class BaseTask {
    ...
    protected static final String GITHUB_PATH = MACHINE_PATH + File.separator + "Download" + File.separator + "WorkSpace" + File.separator + "MyGithub" ;
...
//    protected static final String GRADLE = "/Users/wangzhiguo/.gradle/wrapper/dists/gradle-6.5-bin/6nifqtx7604sqp1q6g8wikw7p/gradle-6.5/bin/gradle";
