...
public class TALBuildTask extends BaseTaskImpl {
    ...
    public int start() {
        ...
        AARTask aarTask = new AARTask(mAARPath);
        aarTask.start();
...
//        restoreForFailed();
    ...
    private boolean startBuild(int version) {
        ...
        mModuleList.add(new VideoModule());
        mModuleList.add(new RtmpModule());
        mModuleList.add(new IjkModule());
        mModuleList.add(new FaceModule());
