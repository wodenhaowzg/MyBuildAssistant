...
//    private static final String IJK_MODULE_EXO_AAR = "/ijkplayer_exo.aar";
    ...
    private final String IJK_MODULE_JAVA_FILE_PATH;
    ...
    public IjkModule(SDKInfo sdkInfo) {
        super(sdkInfo);
        IJK_MODULE_JAVA_FILE_PATH = mSDKInfo.WSTECHAPI_MODULE_PATH + "/src/main/java/com/wushuangtech/wstechapi/internal" + IJK_MODULE_JAVA_FILE;
    }
...
//            return false;
//        }
        boolean b8 = MyFileUtils.moveFile(IJK_MODULE_JAVA_FILE_PATH, mSDKInfo.TEMP_SAVE + IJK_MODULE_JAVA_FILE);
        if (!b8) {
    ...
    private boolean handleIjkCode() {
        boolean b = MyFileUtils.modifyFileContent(mSDKInfo.tttRtcEngineImplFilePath, new MyFileUtils.FileContentListener() {
        ...
        boolean b1 = MyFileUtils.modifyFileContent(mSDKInfo.tttRtcEngineFilePath, new MyFileUtils.FileContentListener() {
        ...
        boolean b2 = MyFileUtils.modifyFileContent(mSDKInfo.wstechBuildGradlePath, new MyFileUtils.FileContentListener() {

            @Override
            public String lineTextContent(String line) {
                if (line.contains(mSDKInfo.wstech_embed_ijk_java) ||
                        line.contains(mSDKInfo.wstech_embed_ijk_exo)) {
                    return "";
                }
                return line;
            }
...
//                MyFileUtils.moveFile(TEMP_SAVE + LIB_ARM64_V8 + IJK_MODULE_SDL_SO, LIB_ARM64_V8_PATH + IJK_MODULE_SDL_SO);
            ...
            MyFileUtils.moveFile(mSDKInfo.TEMP_SAVE + IJK_MODULE_JAVA_FILE, IJK_MODULE_JAVA_FILE_PATH);
        }
        return true;
    }
}
